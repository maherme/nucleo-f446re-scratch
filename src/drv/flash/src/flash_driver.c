...
*       - uint8_t Flash_WriteMemoryByte(uintptr_t address, uint8_t data)
*       - uint8_t Flash_WriteMemoryHalfWord(uintptr_t address, uint16_t data)
*       - uint8_t Flash_WriteMemoryWord(uintptr_t address, uint32_t data)
*       - uint8_t Flash_WriteMemoryDoubleWord(uintptr_t address, uint64_t data)
